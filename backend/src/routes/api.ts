...
import { uploadFile, downloadFile, shareFile, getMyFiles, getSharedWithMe, generateShareLink, getPublicShareInfo, publicDownload } from "../controllers/fileController";
...
router.get("/files/shared-with-me", authenticateJWT, zeroTrustGuard(), getSharedWithMe);
router.post("/files/generate-share-link", authenticateJWT, zeroTrustGuard(), generateShareLink);
router.get("/files/public-share/:shareToken", getPublicShareInfo);
router.get("/files/public-download/:shareToken", publicDownload);
